...
from flask_blog_app import app, db, bcrypt, mail
from flask_blog_app.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
